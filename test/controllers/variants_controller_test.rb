...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { inventory_item_id: @variant.inventory_item_id, product_id: @variant.product_id, quantity: @variant.quantity, title: @variant.title, variant_id: @variant.variant_id } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { inventory_item_id: @variant.inventory_item_id, product_id: @variant.product_id, quantity: @variant.quantity, title: @variant.title, variant_id: @variant.variant_id } }
